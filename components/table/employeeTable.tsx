                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500">ksenia@example.com</div>
                                </div>
                            </div>
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
