        ...
        <div className="pt-20 pl-64 pr-6 min-h-screen w-screen overflow-x-hidden">
            <div className=" mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Documents & Notes</h1>
                        <p className="text-sm text-gray-500 mt-1">Manage all your documents and notes in one place</p>
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100">
                    ...
                    <div className="p-4 border-b border-gray-100">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <button className="px-4 py-2 text-sm font-medium rounded-lg text-brand-500 bg-brand-50">
                                    All Files
                                    <span className="ml-2 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-600">236</span>
                                </button>
                                <button className="px-4 py-2 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50">
                                    Documents
                                    <span className="ml-2 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-600">124</span>
                                </button>
                                <button className="px-4 py-2 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50">
                                    Notes
                                    <span className="ml-2 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-600">45</span>
                                </button>
                                <button className="px-4 py-2 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50">
                                    Shared
                                    <span className="ml-2 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-600">67</span>
                                </button>
                            </div>
                    ...
                    <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="p-4 border border-gray-100 rounded-xl hover:shadow-lg transition-all">
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-medium text-gray-900">Project Requirements.docx</h3>
                        ...
                        <div className="p-4 border border-gray-100 rounded-xl hover:shadow-lg transition-all">
                            <div className="flex gap-4">
                                <div
                                    className="w-10 h-10 rounded-lg bg-yellow-100 flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="font-medium text-gray-900">Sprint Planning Notes</h3>
                                            <p className="text-sm text-gray-500">Updated 3 days ago</p>
                                        </div>
                                        <span
                                            className="px-2 py-1 text-xs font-medium bg-yellow-50 text-yellow-600 rounded-lg">Important</span>
                                    </div>
                                    <div className="mt-3 flex items-center justify-between">
                        ...
                        <div className="p-4 border border-gray-100 rounded-xl hover:shadow-lg transition-all">
                            <div className="flex gap-4">
                                <div
                                    className="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="font-medium text-gray-900">Q3 Performance Review.pdf</h3>
                                            <p className="text-sm text-gray-500">Added 1 week ago</p>
                                        </div>
                                        <span
                                            className="px-2 py-1 text-xs font-medium bg-red-50 text-red-600 rounded-lg">Confidential</span>
                                    </div>
                        ...
                        <div className="p-4 border border-gray-100 rounded-xl hover:shadow-lg transition-all">
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="font-medium text-gray-900">Design System Guidelines</h3>
                                            <p className="text-sm text-gray-500">Last edited by Sarah</p>
                                        </div>
                                        <div className="flex -space-x-2">
                                            {/* <img className="w-6 h-6 rounded-full border-2 border-white"
                                                src="/api/placeholder/24/24" alt="User 1" /> */}
                                            <img className="w-6 h-6 rounded-full border-2 border-white"
                                                src="/images/person1.jpg" alt="User 2" />
                                            <img className="w-6 h-6 rounded-full border-2 border-white"
                                                src="/images/person1.jpg" alt="User 2" />
                                            <div
                                    ...
                                    <div className="mt-3 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-gray-500">Viewed by 28 people</span>
                                        </div>
                                        <button className="p-2 text-gray-400 hover:text-gray-500 rounded-lg hover:bg-gray-50">
                                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
