...
export default function TaskTable() {
    ...
    const handleSelectAllChange=(event:CheckboxChangeEvent)=> {
       ...
       const updatedCheckedItems=Object.keys(checkedItems).reduce((acc,curr)=> {
                ...
                <tbody className="divide-y divide-gray-100">
                    <tr className="table-row-hover">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                            <span className="font-medium text-gray-900">Update User Interface</span>
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
                            <div className="flex items-center gap-2">
                                <Image src="/images/person1.jpg" alt="user" width={32} height={32} className="w-6 h-6 rounded-full" />
                                <span className="text-gray-600">Anatoly Belik</span>
                            </div>
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
                            <span
                                className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-50 text-red-700">
                                High
                            </span>
                        </td>
