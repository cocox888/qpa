                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <h3 className="font-medium text-gray-900">Website Development</h3>
                                <span
                                    className="px-2 py-0.5 rounded text-xs font-medium bg-rose-50 text-rose-600">WDS</span>
                            </div>
            ...
            <div className="px-6 py-4 border-t border-gray-100 bg-gray-50/50 rounded-b-xl">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <a href="#" className="text-xs text-blue-600 hover:text-blue-700">View Repository</a>
                    </div>
                    <button onClick={() => onClick(3, data)}
