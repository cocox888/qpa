                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <div className="w-96">
                                <div className="relative group">
                                    ...
                                    <svg className="w-5 h-5 absolute left-4 top-3 text-gray-400 group-hover:text-brand-500 transition-colors duration-300"
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-4 px-4 py-2 bg-white/50 rounded-2xl border border-gray-100">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-sm font-medium text-gray-900">07:45:22</div>
                                </div>
                                <button
                            ...
                            <div className="relative" ref={notificationsRef}>
                                <button
                                    ...
                                    aria-expanded={isNotificationsMenuOpen} aria-haspopup="true"
                                    onClick={() => setNotificationsMenuOpen(!isNotificationsMenuOpen)}
                                    >
                                    <svg className="w-6 h-6 text-gray-500 group-hover:text-brand-500 transition-colors duration-300"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
                                            d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                                    </svg>
                                    <span
                                        className="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full ring-2 ring-white"></span>
                                </button>

                                {/* <!-- Notifications Dropdown --> */}
                                {isNotificationsMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-80 origin-top-right rounded-2xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                        id="notifications-menu">
                                        <div className="p-4 border-b border-gray-100">
                                            <div className="flex items-center justify-between">
                                                <h2 className="text-sm font-semibold text-gray-900">Notifications</h2>
                                                <span
                                                    className="text-xs font-medium text-brand-500 bg-brand-50 px-2 py-1 rounded-full">5
                                                    new</span>
                                            </div>
                                        </div>
                                        <div className="max-h-96 overflow-y-auto">
                                            ...
                                            <div className="p-2">
                                                <a href="#" className="block p-3 hover:bg-gray-50 rounded-xl transition-colors">
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-xs text-gray-500 mt-0.5">Sarah created a new project:
                                                                Website Redesign</p>
                            ...
                            <div className="relative" ref={profileRef}>
                                <button
                                    ...
                                    aria-expanded={isProfileMenuOpen} aria-haspopup="true"
                                    onClick={() => setProfileMenuOpen(!isProfileMenuOpen)}
                                    >
                                    <div className="relative">
                                        <div
                                            className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-500 to-teal-400 flex items-center justify-center text-sm font-medium text-white shadow-lg shadow-brand-500/20">
                                            JD
                                        </div>
                                        <div
                                    ...
                                    <div className="text-left">
                                        <div className="text-sm font-medium text-gray-700">Bernadette Bawuah</div>
                                ...
                                {/* <!-- Profile Dropdown --> */}
                                {isProfileMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-2xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                        id="profile-menu">
                                        <div className="p-4 border-b border-gray-100">
                                            <div className="flex items-center gap-3">
                                                <div
                                                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-500 to-teal-400 flex items-center justify-center text-lg font-medium text-white">
                                                    JD
                                                </div>
                                                <div>
                                                    <div className="text-sm font-medium text-gray-900">Bernadette Bawuah</div>
                                                    <div className="text-xs text-gray-500">info.qpas@example.com</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="p-2">
