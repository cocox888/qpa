        ...
        >
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className={`inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium ${stat.changeColor}`}>
                {stat.isIncrease ? (
            ...
            <div className="mt-3">
              <div className="w-full bg-white rounded-full h-1">
                <div 
                  className={`h-1 rounded-full ${stat.textColor.replace('text', 'bg')}`}
